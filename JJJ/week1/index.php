...
<head>
  <title>MD Shahin Mia Robin - READ</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
...
<body>
  <div class="container" style="padding: 100px;">
    <br>
    <h1>Welcome to Robin's Profile CRUD Application</h1>
          ...
          <tbody>
            <?php while ($users = $data->fetch(PDO::FETCH_ASSOC)) : ?>
              <tr>
                ...
                <td>
                  <a class="btn btn-info" href="view.php?id=<?= $users['profile_id'] ?>" role="button">
                    View
                  </a>
                </td>
                <td>
                  <a class="btn btn-warning" href="edit.php?id=<?= $users['profile_id'] ?>" role="button">
                    Edit
                  </a>
                </td>
                <td>
                  <a class="btn btn-danger" href="delete.php?id=<?= $users['profile_id'] ?>" role="button">
                    Delete
                  </a>
                </td>
              </tr>
