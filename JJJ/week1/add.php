...
<head>
    <title>MD Shahin Mia Robin - CREATE</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <?php else : ?>
            ...
            <form method="POST">
                ...
                <div class="form-group row">
                    <label for="first_name" class="col-md-3 col-form-label">first_name</label>
                    <div class="col-md-9">
                ...
                <!-- Last Name -->
                <div class="form-group row">
                    <label for="last_name" class="col-md-3 col-form-label">last_name</label>
                    <div class="col-md-9">
